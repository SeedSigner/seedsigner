        ...
        with patch("seedsigner.views.view.RestartView.DoResetThread"):
            self.run_sequence(
                [
                    ...
                    FlowStep(
                        PowerOptionsView, button_data_selection=PowerOptionsView.RESET
                    ),
    ...
    def test_power_off_flow(self):
        ...
        self.run_sequence(
            [
                FlowStep(MainMenuView, screen_return_value=RET_CODE__POWER_BUTTON),
                FlowStep(
                    PowerOptionsView, button_data_selection=PowerOptionsView.POWER_OFF
                ),
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    ...
                    screen_return_value=Exception("Test exception"),
                ),  # <-- force an exception
