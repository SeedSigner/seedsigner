    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        screenshot_sections = {
            ...
            "Seed Views": [
                ...
                ScreenshotConfig(seed_views.SeedShamirShareOptionsView, dict(can_finalize=False, group_threshold=1, shares_entered=2, shares_remaining=1), screenshot_name="SeedShamirShareOptionsView_AddShare"),
                ScreenshotConfig(seed_views.SeedShamirShareOptionsView, dict(can_finalize=True, group_threshold=1, shares_entered=3, shares_remaining=0), screenshot_name="SeedShamirShareOptionsView_Finalize"),
