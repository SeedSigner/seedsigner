    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        screenshot_sections = {
            ...
            "Tools Views": [
                ...
                ScreenshotConfig(tools_views.ToolsCoinEntropyMnemonicLengthView),
                ScreenshotConfig(tools_views.ToolsCoinInputMethodView, dict(total_flips=128), screenshot_name="ToolsCoinInputMethodView_12words"),
                ScreenshotConfig(tools_views.ToolsCoinInputMethodView, dict(total_flips=256), screenshot_name="ToolsCoinInputMethodView_24words"),
                ScreenshotConfig(tools_views.ToolsCoinEntropyEntryView, dict(total_flips=128), screenshot_name="ToolsCoinEntropyEntryView_12words"),
                ScreenshotConfig(tools_views.ToolsCoinEntropyEntryView, dict(total_flips=256), screenshot_name="ToolsCoinEntropyEntryView_24words"),
                ScreenshotConfig(tools_views.ToolsCoinEntropySetwiseEntryView, dict(total_flips=128, current_set=1), screenshot_name="ToolsCoinEntropySetwiseEntryView_12words_set1"),
                ScreenshotConfig(tools_views.ToolsCoinEntropySetwiseEntryView, dict(total_flips=256, current_set=1), screenshot_name="ToolsCoinEntropySetwiseEntryView_24words_set1"),
                ScreenshotConfig(tools_views.ToolsCoinEntropySetwiseBip39WordView, dict(total_flips=128, current_set=1, bits_collected="11111111111", mnemonic=["abandon"], word="abandon"), screenshot_name="ToolsCoinEntropySetwiseBip39WordView_12words"),
                ScreenshotConfig(tools_views.ToolsCoinEntropySetwiseBip39WordView, dict(total_flips=256, current_set=1, bits_collected="11111111111", mnemonic=["abandon"], word="abandon"), screenshot_name="ToolsCoinEntropySetwiseBip39WordView_24words"),
