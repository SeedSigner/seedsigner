    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        screenshot_sections = {
            ...
            "Seed Views": [
                ...
                ScreenshotConfig(seed_views.SeedAccountNumberView,              dict(flow=seed_views.SeedAccountNumberView.FLOW__XPUB_EXPORT, seed=seed_12, sig_type="ss", script_type="nat")),
                ScreenshotConfig(seed_views.SeedAccountNumberErrorView,         dict(flow=seed_views.SeedAccountNumberView.FLOW__XPUB_EXPORT, seed=seed_12, sig_type="ss", script_type="nat", initial_value=str(2**31))),
            ...
            "Tools Views": [
                ...
                ScreenshotConfig(tools_views.ToolsAddressExplorerAddressTypeView, dict(seed=seed_12, script_type=SettingsConstants.NATIVE_SEGWIT, account=1), screenshot_name="ToolsAddressExplorerAddressTypeView_account_1"),
