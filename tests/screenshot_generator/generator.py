...
from seedsigner.gui.toast import (
    DefaultToast,
    DireWarningToast,
    ErrorToast,
    InfoToast,
...
def add_op_return_to_psbt(psbt: PSBT, raw_payload_data: bytes):
    data = (
        compact.to_bytes(OPCODES.OP_RETURN)
...
random.seed(6102)
BASE64_PSBT_WITH_OP_RETURN_RAW_BYTES = add_op_return_to_psbt(
    PSBT.from_base64(BASE64_PSBT_1), random.randbytes(80)
)

mnemonic_12 = (
    "forum undo fragile fade shy sign arrest garment culture tube off merit".split()
)
...
seed_12 = Seed(
    ...
    passphrase="cap*BRACKET3stove",
    wordlist_language_code=SettingsConstants.WORDLIST_LANGUAGE__ENGLISH,
)
seed_24 = Seed(
    mnemonic=mnemonic_24,
    passphrase="some-PASS*phrase9",
    wordlist_language_code=SettingsConstants.WORDLIST_LANGUAGE__ENGLISH,
)
seed_24_w_passphrase = Seed(
    mnemonic=mnemonic_24,
    passphrase="some-PASS*phrase9",
    wordlist_language_code=SettingsConstants.WORDLIST_LANGUAGE__ENGLISH,
)
...
def generate_screenshots(locale):
    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        controller.settings.set_value(
            ...
            [attr for attr, name in SettingsConstants.ALL_SIG_TYPES],
        )
        controller.settings.set_value(
            SettingsConstants.SETTING__SCRIPT_TYPES,
            [attr for attr, name in SettingsConstants.ALL_SCRIPT_TYPES],
        )
        ...
        controller.storage.update_pending_mnemonic(
            word="satoshi", index=11
        )  # random last word; not supposed to be a valid checksum (yet)
        ...
        def load_multisig_wallet_descriptor_cb():
            controller.multisig_wallet_descriptor = (
                embit.descriptor.Descriptor.from_string(MULTISIG_WALLET_DESCRIPTOR)
            )
        ...
        screenshot_sections = {
            "Main Menu Views": [
                ScreenshotConfig(
                    OpeningSplashView,
                    dict(is_screenshot_renderer=True, force_partner_logos=True),
                ),
                ScreenshotConfig(
                    OpeningSplashView,
                    dict(is_screenshot_renderer=True, force_partner_logos=False),
                    screenshot_name="OpeningSplashView_no_partner_logos",
                ),
                ScreenshotConfig(MainMenuView),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_SDCardStateChangeToast_removed",
                    toast_thread=SDCardStateChangeToastManagerThread(
                        action=MicroSD.ACTION__REMOVED, activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_SDCardStateChangeToast_inserted",
                    toast_thread=SDCardStateChangeToastManagerThread(
                ...
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_RemoveSDCardToast",
                    toast_thread=RemoveSDCardToastManagerThread(
                        activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_DefaultToast",
                    toast_thread=DefaultToast(
                        "This is a default text toast!", activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_InfoToast",
                    toast_thread=InfoToast(
                        "This is an info toast!", activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_SuccessToast",
                    toast_thread=SuccessToast(
                        "This is a success toast!", activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_WarningToast",
                    toast_thread=WarningToast(
                        "This is a warning toast!", activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_DireWarningToast",
                    toast_thread=DireWarningToast(
                        "This is a dire warning toast!", activation_delay=0, duration=0
                    ),
                ),
                ScreenshotConfig(
                    MainMenuView,
                    screenshot_name="MainMenuView_ErrorToast",
                    toast_thread=ErrorToast(
                        "This is an error toast!", activation_delay=0, duration=0
                    ),
                ),
            ...
            "Seed Views": [
                ...
                ScreenshotConfig(
                    ...
                    screenshot_name="SeedAddPassphraseView_lowercase",
                ),
                ScreenshotConfig(
                    seed_views.SeedAddPassphraseView,
                    dict(
                        initial_keyboard=SeedAddPassphraseScreen.KEYBOARD__UPPERCASE_BUTTON_TEXT
                    ),
                    screenshot_name="SeedAddPassphraseView_uppercase",
                ),
                ScreenshotConfig(
                    seed_views.SeedAddPassphraseView,
                    dict(
                        initial_keyboard=SeedAddPassphraseScreen.KEYBOARD__DIGITS_BUTTON_TEXT
                    ),
                    screenshot_name="SeedAddPassphraseView_digits",
                ),
                ScreenshotConfig(
                    seed_views.SeedAddPassphraseView,
                    dict(
                        initial_keyboard=SeedAddPassphraseScreen.KEYBOARD__SYMBOLS_1_BUTTON_TEXT
                    ),
                ...
                ScreenshotConfig(
                    seed_views.SeedAddPassphraseView,
                    dict(
                        initial_keyboard=SeedAddPassphraseScreen.KEYBOARD__SYMBOLS_2_BUTTON_TEXT
                    ),
                    screenshot_name="SeedAddPassphraseView_symbols_2",
                ),
                ...
                ScreenshotConfig(
                    seed_views.SeedWordsView,
                    dict(seed_num=0, page_index=2),
                    screenshot_name="SeedWordsView_2",
                ),
                ScreenshotConfig(
                ...
                ScreenshotConfig(
                    ...
                    dict(seed_num=0, num_words=24),
                ),
                ScreenshotConfig(
                    seed_views.SeedBIP85InvalidChildIndexView,
                    dict(seed_num=0, num_words=12),
                ),
                ScreenshotConfig(
                ...
                ScreenshotConfig(
                    seed_views.SeedWordsBackupTestMistakeView,
                ...
                ScreenshotConfig(
                    ...
                    screenshot_name="SeedTranscribeSeedQRWholeQRView_12_Compact",
                ),
                ScreenshotConfig(
                    seed_views.SeedTranscribeSeedQRWholeQRView,
                    dict(seed_num=0, seedqr_format=QRType.SEED__SEEDQR, num_modules=25),
                    screenshot_name="SeedTranscribeSeedQRWholeQRView_12_Standard",
                ),
                ScreenshotConfig(
                    seed_views.SeedTranscribeSeedQRWholeQRView,
                    dict(
                    ...
                    screenshot_name="SeedTranscribeSeedQRWholeQRView_24_Compact",
                ),
                ScreenshotConfig(
                    seed_views.SeedTranscribeSeedQRWholeQRView,
                    dict(seed_num=2, seedqr_format=QRType.SEED__SEEDQR, num_modules=29),
                    screenshot_name="SeedTranscribeSeedQRWholeQRView_24_Standard",
                ),
                ScreenshotConfig(
                    ...
                    screenshot_name="SeedTranscribeSeedQRZoomedInView_12_Compact",
                ),
                ScreenshotConfig(
                    seed_views.SeedTranscribeSeedQRZoomedInView,
                    dict(
                    ...
                    screenshot_name="SeedTranscribeSeedQRZoomedInView_12_Standard",
                ),
                ScreenshotConfig(
                ...
                ScreenshotConfig(
                    seed_views.SeedTranscribeSeedQRConfirmSuccessView, dict(seed_num=0)
                ),
                ...
                ScreenshotConfig(
                    seed_views.SeedSelectSeedView,
                    dict(flow=Controller.FLOW__SIGN_MESSAGE),
                    screenshot_name="SeedSelectSeedView_sign_message",
                ),
            ...
            "PSBT Views": [
                ScreenshotConfig(
                    ...
                    run_before=PSBTSelectSeedView_cb_before,
                ),
                ScreenshotConfig(
                    psbt_views.PSBTOverviewView, run_before=load_basic_psbt_cb
                ),
                ...
                ScreenshotConfig(
                    ...
                    dict(change_address_num=0),
                    screenshot_name="PSBTChangeDetailsView_multisig_unverified",
                    run_before=load_basic_psbt_cb,
                ),
                ScreenshotConfig(
                    psbt_views.PSBTChangeDetailsView,
                    dict(change_address_num=0),
                    screenshot_name="PSBTChangeDetailsView_multisig_verified",
                    run_before=load_multisig_wallet_descriptor_cb,
                ),
                ScreenshotConfig(
                    psbt_views.PSBTOverviewView,
                    screenshot_name="PSBTOverviewView_op_return",
                    run_before=PSBTOverviewView_op_return_cb_before,
                ),
                ScreenshotConfig(
                    psbt_views.PSBTOpReturnView, screenshot_name="PSBTOpReturnView_text"
                ),  # Relies on callback above
                ScreenshotConfig(
                    psbt_views.PSBTOpReturnView,
                    screenshot_name="PSBTOpReturnView_raw_hex_data",
                ...
                ScreenshotConfig(
                    ...
                    screenshot_name="PSBTAddressVerificationFailedView_singlesig_change",
                ),
                ScreenshotConfig(
                    psbt_views.PSBTAddressVerificationFailedView,
                    dict(is_change=False, is_multisig=False),
                    screenshot_name="PSBTAddressVerificationFailedView_singlesig_selftransfer",
                ),
                ScreenshotConfig(
                    psbt_views.PSBTAddressVerificationFailedView,
                    dict(is_change=True, is_multisig=True),
                    screenshot_name="PSBTAddressVerificationFailedView_multisig_change",
                ),
                ScreenshotConfig(
                    psbt_views.PSBTAddressVerificationFailedView,
                    dict(is_change=False, is_multisig=True),
                    screenshot_name="PSBTAddressVerificationFailedView_multisig_selftransfer",
                ),
            ...
            "Tools Views": [
                ...
                ScreenshotConfig(
                    ...
                    screenshot_name="ToolsCalcFinalWordShowFinalWordView_pick_word",
                ),
                ScreenshotConfig(
                    tools_views.ToolsCalcFinalWordShowFinalWordView,
                    dict(coin_flips="0010101"),
                    screenshot_name="ToolsCalcFinalWordShowFinalWordView_coin_flips",
                ),
            ...
            + [
                ...
                ScreenshotConfig(
                    ...
                    screenshot_name="SettingsIngestSettingsQRView_persistent",
                ),
                ScreenshotConfig(
                    settings_views.SettingsIngestSettingsQRView,
                    dict(data=settingsqr_data_not_persistent),
                    screenshot_name="SettingsIngestSettingsQRView_not_persistent",
                ),
            ],
            "Misc Error Views": [
    ...
    def screencap_view(screenshot_config: ScreenshotConfig):
        ...
        with screenshot_renderer.lock:
            screenshot_renderer.set_screenshot_filename(
                f"{screenshot_config.screenshot_name}.png"
            )
    ...
    messages_source_path = os.path.join(
    ...
    locale_tuple_list = [
        locale_tuple
        for locale_tuple in SettingsConstants.ALL_LOCALES
        if locale_tuple[0] == locale
    ]
    ...
    if locale != SettingsConstants.LOCALE__ENGLISH:
        try:
            translated_messages_path = os.path.join(
            ...
            with open(translated_messages_path, "r") as translation_file:
                ...
                num_locale_translations = (
                    locale_translations.count('msgid "')
                    - locale_translations.count("""msgstr ""\n\n""")
                    - 1
                )
    ...
    for section_name, screenshot_list in setup_screenshots(locale).items():
        ...
        screenshot_renderer.set_screenshot_path(
            os.path.join(screenshot_root, locale, subdir)
        )
        locale_readme += "\n\n---\n\n"
        ...
        for screenshot_config in screenshot_list:
            ...
            locale_readme += (
                """  <table align="left" style="border: 1px solid gray;">"""
            )
    ...
    with open(
        os.path.join("tests", "screenshot_generator", "template.md"), "r"
    ) as readme_template:
