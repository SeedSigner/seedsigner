    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        screenshot_sections = {
            ...
            "Seed Views": [
                ...
                ScreenshotConfig(seed_views.SeedBIP352SilentPaymentsOptionsView, dict(seed=seed_12)),
                ScreenshotConfig(seed_views.SeedBIP352GeneratePaymentAddressView, dict(seed=seed_12)),
                ScreenshotConfig(seed_views.SeedBIP352ExportSPDescriptorDetailsView, dict(seed=seed_12)),
