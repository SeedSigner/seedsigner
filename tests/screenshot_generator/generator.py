    ...
    def setup_screenshots(locale: str) -> dict[str, list[ScreenshotConfig]]:
        ...
        screenshot_sections = {
            ...
            "Tools Views": [
                ...
                ScreenshotConfig(tools_views.ToolsCoinEntropySetwiseBip39WordView, dict(total_flips=128, current_set=1, word="abandon", bits="11111111111"), screenshot_name="ToolsCoinEntropySetwiseBip39WordView_12words"),
                ScreenshotConfig(tools_views.ToolsCoinEntropySetwiseBip39WordView, dict(total_flips=256, current_set=1, word="abandon", bits="11111111111"), screenshot_name="ToolsCoinEntropySetwiseBip39WordView_24words"),
