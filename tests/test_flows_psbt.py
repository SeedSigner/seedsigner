...
class TestPSBTFlows(FlowTest):
    ...
    def test_scan_psbt_first_then_correct_seedqr_flow(self):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    scan_views.ScanView, before_run=load_psbt_into_decoder
                ),  # simulate read PSBT; ret val is ignored
                FlowStep(
    ...
    def test_scan_psbt_first_then_load_electrum_seed(self):
        ...
        sequence = [
            ...
            FlowStep(
                psbt_views.PSBTSelectSeedView,
                button_data_selection=psbt_views.PSBTSelectSeedView.TYPE_ELECTRUM,
            ),
        ...
        for (
            word
        ) in "apple drip silly junior language resource unaware whale snake copy gravity tank".split():
            sequence += [
    ...
    def test_scan_multisig_psbt_seed_already_signed_flow(self):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    psbt_views.PSBTChangeDetailsView,
                    button_data_selection=psbt_views.PSBTChangeDetailsView.SKIP_VERIFICATION,
                ),
                FlowStep(
                    psbt_views.PSBTFinalizeView,
                    button_data_selection=psbt_views.PSBTFinalizeView.APPROVE_PSBT,
                ...
                FlowStep(
                    ...
                    button_data_selection=psbt_views.PSBTSigningErrorView.SELECT_DIFF_SEED,
                ),
                FlowStep(
                    psbt_views.PSBTSelectSeedView,
                    button_data_selection=psbt_views.PSBTSelectSeedView.SCAN_SEED,
                ...
                FlowStep(
                    ...
                    screen_return_value=dict(passphrase="abc"),
                ),
                FlowStep(
