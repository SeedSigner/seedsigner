...
def test_missing_settings_get_defaults(reset_controller):
    ...
    assert controller.settings.get_value(SettingsConstants.SETTING__COORDINATORS) == [
    ...
    assert controller.settings.get_value(SettingsConstants.SETTING__SCRIPT_TYPES) == [
