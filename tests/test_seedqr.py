...
def run_encode_decode_test(entropy: bytes, mnemonic_length, qr_type):
    ...
    qr = QR()
    image = qr.qrimage(data=data, width=240, height=240, border=3)
...
def test_standard_seedqr_encode_decode_():
    ...
    run_encode_decode_test(
        os.urandom(32), mnemonic_length=24, qr_type=QRType.SEED__SEEDQR
    )

    # 12-word seed
    run_encode_decode_test(
        os.urandom(16), mnemonic_length=12, qr_type=QRType.SEED__SEEDQR
    )
...
def test_compact_seedqr_encode_decode():
    ...
    # 24-word seed
    run_encode_decode_test(
        os.urandom(32), mnemonic_length=24, qr_type=QRType.SEED__COMPACTSEEDQR
    )

    # 12-word seed
    run_encode_decode_test(
        os.urandom(16), mnemonic_length=12, qr_type=QRType.SEED__COMPACTSEEDQR
    )
...
def test_compact_seedqr_handles_null_bytes():
    ...
    run_encode_decode_test(
        entropy, mnemonic_length=24, qr_type=QRType.SEED__COMPACTSEEDQR
    )
    ...
    run_encode_decode_test(
        entropy, mnemonic_length=12, qr_type=QRType.SEED__COMPACTSEEDQR
    )
...
def test_compact_seedqr_bytes_interpretable_as_str():
    ...
    for entropy_bytes in entropy_bytes_tests:
        ...
        run_encode_decode_test(
            ...
            qr_type=QRType.SEED__COMPACTSEEDQR,
        )
