...
def test_specter_qr_encode():
    ...
    while cnt <= 10:
        ...
        if (cnt + 1) == 1:
            assert (
                fragment
                == "p1of117 cHNidP8BAIkCAAAAAaLlQ/VRNpx3IFtoRTOCnq2xfJwg/n7R9XB0TTTnlX/UHQAAA"
            )
        elif (cnt + 1) == 2:
            assert (
                fragment
                == "p2of117 AD9////AtzQAwAAAAAAIgAgCwVSg4Ae1lGNHzy76jLN6GSQaSVnktnmNDByu/wkn7"
            )
        elif (cnt + 1) == 3:
            assert (
                fragment
                == "p3of117 FQwwAAAAAAACIAIJyFZJe7xxQjXpoEBhb8mIkau9OhobDS7xbYxnRIjJUSAAAAAE8"
            )
        elif (cnt + 1) == 4:
            assert (
                fragment
            ...
            assert (
                fragment
                == "p5of117 +t61zOqKFV1xXtDPuUcQRh3M92zh0Zar8rDLPJKQFH7fnFkwAACAAAAAgAAAAIACA"
            )
        elif (cnt + 1) == 6:
            assert (
                fragment
                == "p6of117 ACATwEEiLIeBFIg7+eAAAACubwMfJNby3zfn9owhFfgl/Xe/GiHciMMxxB9v6q7BW"
            )
        elif (cnt + 1) == 7:
            assert (
                fragment
                == "p7of117 cCurV9rH+K8ucVU3w52mcEttDldz7kh5cS0xBtWs7wmTYU4IEbazAAAIAAAACAAAA"
            )
        elif (cnt + 1) == 8:
            assert (
                fragment
                == "p8of117 AgAIAAIBPAQSIsh4EX+8GLoAAAALvSlncnGchVCfK7tnzHPVYcBRcck0JGQuspGFp"
            )
        elif (cnt + 1) == 9:
            assert (
                fragment
            ...
            assert (
                fragment
                == "p10of117 IAAAACAAgAAgE8BBIiyHgRgkAVVgAAAAsgLKl/ahhLHvS/3Cth+9Hde12MHJO5PP8"
            )
        elif (cnt + 1) == 11:
            assert (
                fragment
                == "p11of117 REKtbWkqONAvETqIlMPWJ/f1uBvSCGFm+zzDYnnEBtuAYjZiQrzj9mFLQz4JUwAAC"
            )
...
def test_xpub_qr():
    ...
    assert (
        e.next_part()
        == "[c49122a5/48h/1h/0h/2h]Vpub5mXgECaX5yYDNc5VnUG4jVNptyEg65qUjuofWchQeuMWWiq8rcPBoMxfrVggXj5NJmaNEToWpax8GMMucozvAdqf1bW1JsZsfdBzsK3VUC5"
    )
