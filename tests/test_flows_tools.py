...
class TestToolsFlows(FlowTest):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    ...
                    button_data_selection=tools_views.ToolsMenuView.ADDRESS_EXPLORER,
                ),
                FlowStep(
                    tools_views.ToolsAddressExplorerSelectSourceView,
                    screen_return_value=0,
                ),  # ret 1st onboard seed
                FlowStep(
                    ...
                    button_data_selection=ButtonOption(
                        ...
                        ).get_selection_option_display_name_by_value(
                ...
                FlowStep(
                    ...
                    screen_return_value=10,
                ),  # ret NEXT page of addrs
                FlowStep(
                    tools_views.ToolsAddressExplorerAddressListView,
                    screen_return_value=4,
                ),  # ret a specific addr from the list
                FlowStep(
                    tools_views.ToolsAddressExplorerAddressView
                ),  # runs until dismissed; no ret value
    ...
    def test__address_explorer__loadseed__sideflow(self):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    scan_views.ScanSeedQRView, before_run=load_seed_into_decoder
                ),  # simulate read SeedQR
                FlowStep(
        ...
        self.controller.storage.set_pending_seed(
            Seed(mnemonic=["abandon " * 11 + "about"])
        )
        ...
        self.run_sequence(
            sequence=[
                ...
                FlowStep(
                    ...
                    screen_return_value=dict(passphrase="mypassphrase"),
                ),
                FlowStep(
    ...
    def test__address_explorer__load_electrum_seed__sideflow(self):
        ...
        sequence = [
            ...
            FlowStep(
                tools_views.ToolsAddressExplorerSelectSourceView,
                button_data_selection=tools_views.ToolsAddressExplorerSelectSourceView.TYPE_ELECTRUM,
            ),
        ...
        for (
            word
        ) in "regular reject rare profit once math fringe chase until ketchup century escape".split():
            sequence += [
    ...
    def test__address_explorer__scan_wrong_qrtype__flow(self):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    scan_views.ScanSeedQRView, before_run=load_wrong_data_into_decoder
                ),  # simulate scanning the wrong QR type
                FlowStep(ErrorView),
            ]
        )
        ...
        * One script type enabled: BACK to where we started:
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    seed_views.SeedsMenuView, screen_return_value=0
                ),  # select the first onboard seed
                FlowStep(
                    seed_views.SeedOptionsView,
                    button_data_selection=seed_views.SeedOptionsView.EXPLORER,
                ),
                FlowStep(
    ...
    def test__address_explorer__legacy_multisig_p2sh__flow(self):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    tools_views.ToolsAddressExplorerSelectSourceView,
                    button_data_selection=tools_views.ToolsAddressExplorerSelectSourceView.SCAN_DESCRIPTOR,
                ),
                FlowStep(
                    scan_views.ScanWalletDescriptorView,
                    before_run=load_descriptor_into_decoder,
                ),  # simulate read descriptor QR
                FlowStep(
                    seed_views.MultisigWalletDescriptorView,
                    button_data_selection=seed_views.MultisigWalletDescriptorView.ADDRESS_EXPLORER,
                ),
                FlowStep(
                    tools_views.ToolsAddressExplorerAddressTypeView,
                    button_data_selection=tools_views.ToolsAddressExplorerAddressTypeView.RECEIVE,
    ...
    def test__verify_address__legacy_multisig_p2sh__flow(self):
        ...
        self.run_sequence(
            [
                ...
                FlowStep(
                    tools_views.ToolsMenuView,
                    button_data_selection=tools_views.ToolsMenuView.VERIFY_ADDRESS,
                ),
                FlowStep(
                    scan_views.ScanAddressView, before_run=load_address_into_decoder
                ),  # simulate read address QR
                FlowStep(seed_views.AddressVerificationStartView, is_redirect=True),
                FlowStep(
                    seed_views.AddressVerificationSigTypeView,
                    button_data_selection=seed_views.AddressVerificationSigTypeView.MULTISIG,
                ),
                FlowStep(
                    seed_views.LoadMultisigWalletDescriptorView,
                    button_data_selection=seed_views.LoadMultisigWalletDescriptorView.SCAN,
                ),
                FlowStep(
                    scan_views.ScanWalletDescriptorView,
                    before_run=load_descriptor_into_decoder,
                ...
                FlowStep(
                    seed_views.MultisigWalletDescriptorView, screen_return_value=0
                ),
