...
class PSBTTestData:
    ...
    # Unlike the fixtures above, this is a complete psbt (outputs intact) and its own wallet.
    # 2 inputs of 56,522,834 and 1,990,245,069 sats; 1 external recipient + 3 change outputs.
    # Regtest 394aed14 m/84'/1'/0'. Used wherever a test needs more than one input.
