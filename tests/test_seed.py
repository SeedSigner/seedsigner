...
class TestBruteForceAddressVerificationThread(BaseTest):
    def test_brute_force(self):
        ...
        the expected result.
        """
        # TODO: test all supported address types (e.g. nested segwit)
        ...
        target_address = "bc1qy3y3zq7rclp9fwds2z95w9ru3r5pkyfhchcqgq"
        expected_index = 21
        ...
        assert verified_index.cur_value == expected_index
