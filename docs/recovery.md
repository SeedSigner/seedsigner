...
Because passphrase usage has not been standardized in BIP-0039 nor across wallets and signing devices, SeedSigner does not place a limit on seed passphrase length. 
