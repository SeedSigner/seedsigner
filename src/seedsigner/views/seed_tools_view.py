...
class SeedToolsView(View):
    ...
    def draw_passphrase_keyboard_entry(self, existing_passphrase = ""):
        ...
        self.renderer.draw.text((int(self.canvas_width - tw) / 2, title_top_padding), text=title, font=font, fill=self.color)
        ...
        text_entry_display = TextEntryDisplay(
            rect=(text_entry_side_padding,text_entry_top_y, self.canvas_width - right_panel_buttons_width - 1, text_entry_bottom_y),
            font=font,
            font_color=self.color,
        ...
        keyboard_abc = Keyboard(
            ...
            rows=4,
            cols=9,
            rect=(0, keyboard_start_y, self.canvas_width - right_panel_buttons_width, self.canvas_height),
