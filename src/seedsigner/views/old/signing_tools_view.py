...
class SigningToolsView(View):
    ...
    def display_transaction_information(self, p) -> None:
        ...
        tw, th = self.draw.textsize("Confirm Tx Details", font=Fonts.get_font("Assistant-Medium", 25))
        self.draw.text(((240 - tw) / 2, 3), "Confirm Tx Details", fill=View.color, font=Fonts.get_font("Assistant-Medium", 25))
        ...
        tw, th = self.draw.textsize(in_fee_outs_str, font=Fonts.get_font("Assistant-Medium", 22))
        self.draw.text(((240 - tw) / 2, 40), in_fee_outs_str, fill=View.color, font=Fonts.get_font("Assistant-Medium", 22))
        ...
        tw, th = self.draw.textsize(receiving_addr_str1, font=Fonts.get_font("Assistant-Medium", 22))
        ...
        if p.spend_amount > 0:
            ...
            tw, th = self.draw.textsize(spending_str, font=Fonts.get_font("Assistant-Medium", 22))
            self.draw.text(((240 - tw) / 2, 130), spending_str, fill=View.color, font=Fonts.get_font("Assistant-Medium", 22))

        if p.change_amount > 0 and len(p.destination_addresses) == 0:
            change_str = "Amount: " + str(p.change_amount) + " sats"
            tw, th = self.draw.textsize(change_str, font=Fonts.get_font("Assistant-Medium", 22))
            self.draw.text(((240 - tw) / 2, 155), change_str, fill=View.color, font=Fonts.get_font("Assistant-Medium", 22))
        ...
        tw, th = self.draw.textsize(fee_str, font=Fonts.get_font("Assistant-Medium", 22))
        self.draw.text(((240 - tw) / 2, 180), fee_str, fill=View.color, font=Fonts.get_font("Assistant-Medium", 22))

        tw, th = self.draw.textsize("Left to Exit, Right to Continue", font=Fonts.get_font("Assistant-Medium", 18))
        self.draw.text(((240 - tw) / 2, 215), "Left to Exit, Right to Continue", fill=View.color, font=Fonts.get_font("Assistant-Medium", 18))
    ...
    def qr_gen_status(percentage):
        ...
        tw, th = self.renderer.draw.textsize("QR Generation", font=Fonts.get_font("Assistant-Medium", 25))
        self.renderer.draw.text(((240 - tw) / 2, 90), "QR Generation", fill=View.color, font=Fonts.get_font("Assistant-Medium", 25))
        tw, th = self.renderer.draw.textsize(str(round(percentage)) + "% Complete", font=Fonts.get_font("Assistant-Medium", 25))
        self.renderer.draw.text(((240 - tw) / 2, 125), str(round(percentage)) + "% Complete", fill=View.color, font=Fonts.get_font("Assistant-Medium", 25))
        self.renderer.show_image()
