...
class Display:
    ...
    def run(self):
        ...
        self.btnL = Button(
            ...
            width=20,
            height=20,
            command=HardwareButtons.KEY_LEFT_PIN,
        )
        ...
        self.btnR = Button(
            ...
            width=20,
            height=20,
            command=HardwareButtons.KEY_RIGHT_PIN,
        )
        ...
        self.btnU = Button(
            ...
            width=20,
            height=20,
            command=HardwareButtons.KEY_UP_PIN,
        )
        ...
        self.btnD = Button(
            ...
            width=20,
            height=20,
            command=HardwareButtons.KEY_DOWN_PIN,
        )
        ...
        self.btn1 = Button(
            ...
            width=40,
            height=20,
            command=HardwareButtons.KEY1_PIN,
        )
        ...
        self.btn2 = Button(
            ...
            width=40,
            height=20,
            command=HardwareButtons.KEY2_PIN,
        )
        ...
        self.btn3 = Button(
            ...
            width=40,
            height=20,
            command=HardwareButtons.KEY3_PIN,
        )
        ...
        def key_handler(event):
            if event.keysym == "Up":
                self.key_press(HardwareButtons.KEY_UP_PIN)
            if event.keysym == "Down":
                self.key_press(HardwareButtons.KEY_DOWN_PIN)
            if event.keysym == "Left":
                self.key_press(HardwareButtons.KEY_LEFT_PIN)
            if event.keysym == "Right":
                self.key_press(HardwareButtons.KEY_RIGHT_PIN)

            if event.keysym in ("1", "KP_1"):
                self.key_press(HardwareButtons.KEY1_PIN)
            if event.keysym in ("2", "KP_2"):
                self.key_press(HardwareButtons.KEY2_PIN)
            if event.keysym in ("3", "KP_3"):
                self.key_press(HardwareButtons.KEY3_PIN)

            if event.keysym == "Return":
                self.key_press(HardwareButtons.KEY_PRESS_PIN)
