...
| --------------------- | --------------------------------- |
|[Raspberry Pi Zero](https://www.raspberrypi.com/products/raspberry-pi-zero/)      |[`seedsigner_os.0.6.0.pi0.img`](https://github.com/SeedSigner/seedsigner/releases/download/0.6.0/seedsigner_os.0.6.0.pi0.img)      |
